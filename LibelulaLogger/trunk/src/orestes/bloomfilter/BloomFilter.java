...
public class BloomFilter<T> implements Cloneable, Serializable {
     ...
     * <i>bloomFilter</i>.
     *
     * @param bloomFilter the bit vector used to construct the bloom filter
     * @param k the number of hash functions used
     * @param hashMethod hash function type
     * @param hashFunctionName name of the hash function to be used for the
     * cryptographic HashMethod, i.e. MD2, MD5, SHA-1, SHA-256, SHA-384 or
     * SHA-512
     */
     ...
     *
     * @param hashFunctionName name of the hash function to be used, i.e. MD2,
     ...
     *
     * @param chf the custom hash function
     */
    ...
    public synchronized boolean equals(Object obj) {
        ...
        BloomFilter<String> other = (BloomFilter<String>) obj;
        if (bloom == null) {
            if (other.bloom != null) {
                return false;
            }
    ...
    public static interface CustomHashFunction {
         ...
         * @param m integer output range [1,m]
